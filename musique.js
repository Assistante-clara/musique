...
if(data.ArretMusiqueLieux=="stop"){ ClaraIASound("   ",ClaraIA.ipappel) ; return }
if(data.ArretMusiqueLieux!==undefined){ ClaraIASound("   ",data.ArretMusiqueLieux) ; return}


ClaraAskMe('quelle type de musique',function(result){
  ...
  var pathe=chemin+'\\'+result ; var listeMusique=[]
    ...
    function zz(pathe,compteur) {
      ...
      console.log(liste)
      ClaraIASound(liste,data.MusiqueLieux)
      return
}//fin fnct zz
